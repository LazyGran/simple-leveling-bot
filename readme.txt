...
-https://www.getdroidtips.com/discord-bot-token/ 
    That isnt my website, has some flaws. You dont need to discribe your bot in a minimun of 400 words for example, 
    you dont have to describe i at all
Add your bot to your server
Open this folder in the Windows command prompt
    to do that, open windows command prompt
    type in the following "cd (path to the folder)"
Type in "npm i discord.js"
Type in "npm i jsonfile"
Type in "npm i random
Type in "node ."
...
When typing in the 3 npm i commands, ignore every warning!
If you are having any problems, please reach out to me via discord -> xGraron#6683
